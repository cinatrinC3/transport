...
\begin{document}
\begin{CJK*}{UTF8}{bkai}
\subsection{質量輸送，Stefan Problem、Pseudo-steady State}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  ...
  \end{align}
  \item 將邊界條件(\ref{eq:ch4_3_stefan_bc2}), (\ref{eq:ch4_3_stefan_bc3})代入，解出常數$C_5$與驗證$N_{Az}$:
  \begin{align}
  ...
  \item 針對液體:
  \begin{equation}
    \frac{\pi R^2\rho_A dz_l}{M_A dt} = -N_{Az}(z_l) \pi R^2
  \end{equation}
  代入$N_{Az}$，得到:
  \begin{equation}
