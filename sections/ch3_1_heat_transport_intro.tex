  ...
  \item Govering Equation:
    \begin{itemize}
      ...
      \item Convective transfer (熱對流)\\
        ...
        \begin{equation}
          (\frac{1}{2}\rho \left|\vec{\bm u}\right|^2 + \rho \hat U)\vec{\bm u} = \rho \hat E \vec{\bm u}
        \end{equation}
      ...
      \item Equation of Energy\\
        ...
        \begin{equation}
          \rho \frac{D\hat U}{Dt} = 
          - \nabla \cdot \vec{\bm q} - P  \nabla \cdot \vec{\bm u} + \overline{\overline{\bm \tau}} : \left(\nabla \vec{\bm u}\right)
        \end{equation}
        利用$\hat H = \hat U + P\hat V\to \hat U + P\frac{1}{\rho}$，可以換成:
        %TODO 省略
        \begin{equation}
          \rho \frac{D\hat H}{Dt} = -\nabla \cdot \vec{\bm q} + \frac{D P}{Dt} + \overline{\overline{\bm \tau}} : \left(\nabla \vec{\bm u}\right)
        \end{equation}
        利用物化的$\hat H(T,P)$，換掉$\rho \frac{D\hat H}{Dt}$:
        \begin{equation}
          \rho \frac{D\hat H}{Dt} = \rho \hat C_p \frac{DT}{Dt} + \left[
            1 - \left(
