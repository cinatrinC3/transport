...
\begin{itemize}
  ...
  \begin{enumerate}
    ...
    \end{equation}
    \item 用Adiabatic Mixing Cup的溫度($T_{\text{AMC}}$)來找到$\lambda_n$ \label{sec:graetz_amc_temperature}\\
  ...
  \begin{enumerate}
    ...
    \begin{align}
      ...
      \Rightarrow & \frac{L_{\text{entry}}}{2R} = \left(
        \frac{1}{2.912}
      \right)^3 \text{Pe} \nonumber\\
      \Rightarrow & \boxed{L_{\text{entry}} = 0.0405 \text{Pe} \cdot 2R} \label{eq:leveque_entry_length}
    \end{align}
  ...
  \begin{enumerate}
    ...
    因此可以得到兩邊界層的比例關係:
    \begin{equation}
      \frac{\rho \hat C_P U \delta_T^3}{k L\delta} = a \approx 1
    \end{equation}
    以$\delta_T$來看:
    \begin{equation}
      \delta_T = a\left(
    ...
    同除$\delta$，得到:
    \begin{equation}
      \boxed{\frac{\delta_T}{\delta} = a\left(
        \frac{kL}{\rho \hat C_P U\delta^2}
    ...
    \begin{align}
      & \frac{\delta_T}{\delta} = a\left(
        \frac{kL}{\rho \hat C_P U} \cdot \frac{\rho U}{\mu L}
      \right)^{\frac{1}{3}} \nonumber\\
      \Rightarrow & \frac{\delta_T}{\delta} = a\left(
        \frac{k}{\hat C_P \mu}
      \right)^{\frac{1}{3}} \nonumber\\
      \Rightarrow & \boxed{\frac{\delta_T}{\delta} = a\text{Pr}^{-\frac{1}{3}}}
    \end{align}
    也就是說當Prandtl Number越大，熱傳邊界層相對於流體邊界層就越薄\\
    衍生，如果將$\frac{\delta_T}{L}$表示出來:
    \begin{align}
      & \frac{\delta_T}{L} = \frac{\delta_T}{\delta} \cdot \frac{\delta}{L} \nonumber\\
      \Rightarrow & \boxed{\frac{\delta_T}{L} = a\text{Re}_L^{-\frac{1}{2}} \text{Pr}^{-\frac{1}{3}}}
    \end{align}
    ...
    \begin{align}
      ...
      \Rightarrow & \boxed{\text{Nu}_L = a^{-1}\text{Re}_L^{\frac{1}{2}} \text{Pr}^{\frac{1}{3}}}
    \end{align}
    而這個的數值解則是$a^{-1} = 0.664$，與Blasius解法相同
    \begin{equation}
      \text{Nu}_L = 0.664 \text{Re}_L^{\frac{1}{2}} \text{Pr}^{\frac{1}{3}} \label{eq:graetz_nusselt_number_final}
    \end{equation}
